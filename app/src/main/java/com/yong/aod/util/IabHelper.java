 ...
 * items. See {@link #queryInventory}, {@link #queryInventoryAsync}
 * and related methods.
 *
...
public class IabHelper {
	...
	throws IabAsyncInProgressException {
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                // Purchasing a new item re-signup
            ...
            if (buyIntentBundle != null) {
                ...
                logError("BuyIntentBundle is null in purchase flow for sku " + sku);
            }
        }
    ...
    public Inventory queryInventory() throws IabException {
        return queryInventory(false, null);
    }
     ...
     */
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus) throws IabException {
        checkNotDisposed();
	...
	throws IabAsyncInProgressException {
        ...
        (new Thread(new Runnable() {
				public void run() {
					...
					Inventory inv = null;
					try {
						inv = queryInventory(querySkuDetails, moreItemSkus);
					}
	...
	throws IabAsyncInProgressException{
        queryInventoryAsync(false, null, listener);
    }
